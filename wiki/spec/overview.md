...
- **v1 loop: shipped** (code complete). See
  [feature page](../features/lead_discovery_and_queue.md).
- **Not yet live:** the leads sheet + Apps Script webhook are deployed and
  tested (a row writes end-to-end). Remaining: wire the Anthropic + Reddit keys
  and run it once.
